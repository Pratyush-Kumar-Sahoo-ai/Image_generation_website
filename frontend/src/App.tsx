...
function App() {
  ...
  const [apiUrl, setApiUrl] = useState(process.env.REACT_APP_API_URL || 'https://lumina-backend-cwms2mqttq-el.a.run.app');
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <p>Transform your imagination into stunning visuals - v1.0.2</p>
      </header>
